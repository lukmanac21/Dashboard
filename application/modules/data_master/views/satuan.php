<div class="main">
    <div class="page-header">
        ...
        <div class="breadcrumb">
            <div class="breadcrumb-item"><a href="index.html"> Data Master </a></div>
            <div class="breadcrumb-item"><a href="javascript:void(0)"> Satuan </a></div>
        </div>
    </div>
    <div class="card">
        <?php if(isset($list)){?>
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($table as $data) { ?>
                                <tr>
                                    ...
                                    <?php if ($data->is_active == 1) $status="checked"; else $status="" ;?>
                                    <td>
                                        <div class="form-check form-switch">
                                            <form id="form_<?= $data->id ?>" action="<?= site_url('satuan_check')?>" method="post">
                                                <input class="form-check-input check" name="checkbox" id="<?= $data->id ?>" type="checkbox" id="flexSwitchCheckDefault" <?= $status ?>>
                                    ...
                                    <td>
                                        <div class="d-grid gap-2 d-md-block">
                                            <a type="button" href="<?= site_url('satuan_edit/'.$data->id)?>" class="btn btn-primary" title="Edit"><i class="icon-edit feather"></i>
                                            </a>
                ...
                <form class="row g-3" method="post" action="<?= site_url('satuan_add')?>">
                    <div class="col-md-6">
    ...
    <?php } elseif(isset($edit)){?>
            ...
            <?php foreach ($table as $data) { ?>
                <form class="row g-3" method="post" action="<?= site_url('satuan_update')?>">
                    <div class="col-md-6">
    ...
    <div class="modal fade" id="delete<?= $data->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= site_url('satuan_delete');?>" method="post">

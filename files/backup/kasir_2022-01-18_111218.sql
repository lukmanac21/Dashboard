...
#
# TABLE STRUCTURE FOR: barang_detail
#
...
INSERT INTO `module_groups` (`id`, `name`, `short_code`, `icon`, `is_active`) VALUES (3, 'Transaksi', 'transaksi', '1', 1);
INSERT INTO `module_groups` (`id`, `name`, `short_code`, `icon`, `is_active`) VALUES (4, 'Laporan', 'laporan', '1', 1);
...
INSERT INTO `module_operations` (`id`, `m_group_id`, `name`, `slug`, `can_view`, `can_add`, `can_edit`, `can_delete`) VALUES (6, 1, 'Role', 'roles', 1, 1, 1, 0);
INSERT INTO `module_operations` (`id`, `m_group_id`, `name`, `slug`, `can_view`, `can_add`, `can_edit`, `can_delete`) VALUES (7, 2, 'Data Barang', 'barang', 1, 1, 1, NULL);
INSERT INTO `module_operations` (`id`, `m_group_id`, `name`, `slug`, `can_view`, `can_add`, `can_edit`, `can_delete`) VALUES (8, 2, 'Perubahan Harga', 'perharga', 1, 1, 1, 0);
INSERT INTO `module_operations` (`id`, `m_group_id`, `name`, `slug`, `can_view`, `can_add`, `can_edit`, `can_delete`) VALUES (10, 4, 'Penjualan', 'lappenjualan', 1, NULL, NULL, NULL);
INSERT INTO `module_operations` (`id`, `m_group_id`, `name`, `slug`, `can_view`, `can_add`, `can_edit`, `can_delete`) VALUES (40, 3, 'Penjualan', 'trpenjualan', 1, 1, 1, 0);
...
INSERT INTO `settings` (`id`, `name`, `email`, `phone`, `address`, `instagram`, `youtube`, `whatsapp`, `timezone`, `logo`, `kota`, `propinsi`, `zip`, `created_at`, `updated_at`, `app_logo`, `footer`, `login_background`, `login_logo`, `keyword`, `site_desc`, `home_title`, `site_title`, `latitude`, `longitude`) VALUES (0, 'KASIR', '-', '082332313232', '-', '-', '-', '-', 'UTC', '1632720548_icon-32x32.png', '', '', '-', '2020-03-12 00:00:00', '2021-10-18 10:45:07', '1632720548_icon-32x32.png', 'Copyright © 2021 Theme_Nate. All rights reserved.', '', NULL, NULL, NULL, NULL, 'KASIR', '-7.9146022', '113.8217761');
